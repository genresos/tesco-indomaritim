...
<div>
    ...
    <a href="{{ route('employees.daily-worker.attendance-export', ['fromDate' => '', 'toDate' => '']) }}" class="btn btn-success" id="exportButton">
...
<script>
    $(document).ready(function() {
        ...
        $('#exportButton').on('click', function(e) {
            ...
            var url = "{{ route('employees.daily-worker.attendance-export', ['fromDate' => ':fromDate', 'toDate' => ':toDate']) }}";
